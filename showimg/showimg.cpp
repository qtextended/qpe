...
** not clear to you.
**
** $Id: showimg.cpp,v 1.20 2001/09/05 08:01:35 elhedran Exp $
**
**********************************************************************/
...
void ImageViewer::fullScreen()
{
	...
	isFullScreen = TRUE;
	imagePanel->reparent(0,WStyle_Tool | WStyle_Customize | WStyle_StaysOnTop,
			    QPoint(0,0),FALSE);
...
void ImageViewer::updateStatus()
{
	...
	message += tr(", %1 bits ").arg(image.depth());
