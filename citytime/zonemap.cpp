...
** not clear to you.
**
** $Id: zonemap.cpp,v 1.45 2001/08/13 03:40:46 warwick Exp $
**
**********************************************************************/
...
ZoneField::ZoneField( const QString& strLine )
{
    ...
    QRegExp regCountry( "[A-Za-z]+/" ); // the country
...
void ZoneMap::slotFindCity( const QPoint &pos )
{
	...
	if ( lblCity->height() > drawableH - y ) {
	    ...
	    // the citiy is actually off the screen...
