...
** not clear to you.
**
** $Id: gowidget.cpp,v 1.12 2001/08/29 08:32:15 warwick Exp $
**
**********************************************************************/
#include "gowidget.h"
#include "config.h"
	...
	QMainWindow( parent, name ) 
{
    ...
    a = new QAction( tr( "Twoplayer option" ),  QString::null, 0, this, 0 );
...
void GoWidget::mouseReleaseEvent( QMouseEvent *me )
{
