...
** not clear to you.
**
** $Id: lightstyle.cpp,v 1.11 2001/08/29 08:32:15 warwick Exp $
**
**********************************************************************/
                                 ...
                                 bool sunken, const QBrush *fill)
{
    ...
    p->fillRect(x, y, 2, 2, g.background());
    p->fillRect(x+w-2, y, 2, 2, g.background());
    p->fillRect(x, y+h-2, 2, 2, g.background());
    p->fillRect(x+w-2, y+h-2, 2, 2, g.background());
    if ( fill )
