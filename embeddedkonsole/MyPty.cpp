...
#ifndef NO_OPENPTY // compile with this defined if this fails
#include <pty.h>
#endif
...
#if defined (TIOCSCTTY) && !defined(CIBAUD) || defined(QPE_NOCIBAUD)
...
#ifdef NO_OPENPTY // compile with this defined if the other branch fails
